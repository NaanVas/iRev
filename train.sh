...
do
    ...
    #python3 main.py train --model=HRDR --dataset=$dataset --batch_size=32 --emb_opt=word2vec --num-fea=2 
    ...
    #python3 main.py train --model=MAN --dataset=$dataset --batch_size=8 --man=True --emb_opt=word2vec --output=nfm
done